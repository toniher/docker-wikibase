...
${LOCALSETTINGS_MOUNT} -v ${CONF_PATH}/LocalSettings.local.php:/var/www/w/LocalSettings.local.php -v ${CONF_PATH}/LocalSettings.redis.php:/var/www/w/LocalSettings.redis.php -v ${CONF_PATH}/LocalSettings.elastic.php:/var/www/w/LocalSettings.elastic.php \
